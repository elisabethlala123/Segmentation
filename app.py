...
class App:
    def __init__(self, root):
        self.root = root
        self.root.title("KATAN")

        # Canvas sebagai latar belakang untuk header
        self.header_canvas = tk.Canvas(self.root, bg="#7893D6", height=50, width=600)
        self.header_canvas.pack(fill="x")  # Mengisi latar belakang header ke seluruh lebar jendela

        # Muat gambar logo
        self.logo_image = Image.open("Logo/logo_nama.png")
        new_size = (125, 125)
        self.logo_image = self.logo_image.resize(new_size, Image.ANTIALIAS)
        ...
        # Title
        self.title_label = tk.Label(self.main_frame, text="Segmentasi Dan Analisis Suhu Terpanas Tubuh Manusia", font=("Montserrat", 18, "bold"))
        ...
        # Upload Image Button
        self.upload_image_button = tk.Button(self.main_frame, text="Upload Image", command=self.upload_image, bg="#7893D6", font=("Montserrat", 15))
        self.upload_image_button.grid(row=10, column=0, padx=5)

        # Use Camera Button
        self.use_camera_button = tk.Button(self.main_frame, text="Use Camera", command=self.use_camera, bg="#7893D6", font=("Montserrat", 15))
        self.use_camera_button.grid(row=10, column=1, padx=5)
